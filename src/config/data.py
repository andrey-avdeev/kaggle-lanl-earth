...
FEATURES_ARTGOR_DIR = 'features_artgor/'
...
FEATURES_ARTGOR_FILENAME = 'features_artgor.csv'

ROWS_PER_SEGMENT = 150000

STANDARD_ROWS_COUNT = 8000
STANDARD_ROWS_SEGMENT_ID_PREFIX = 'rd_'

SMALL_ROWS_PER_SEGMENT = 50000
SMALL_ROWS_COUNT = 15000
SMALL_ROWS_SEGMENT_ID_PREFIX = 'sm_'
